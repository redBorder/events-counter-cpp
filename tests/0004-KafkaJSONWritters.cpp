...
class KafkaJSONWrittersTest : public ::testing::Test {};

TEST_F(KafkaJSONWrittersTest, produce_monitor_message) {
...
TEST_F(KafkaJSONWrittersTest, produce_counter_message) {
  char tmpl[] = "test_XXXXXX";
  char *tmp_str = rand_tmpl(tmpl);
